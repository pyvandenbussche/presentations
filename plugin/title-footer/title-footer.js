...
title_footer.initialize=function(title,background)
{
	...
	// add fullscreen
	var title_footer_div_menu=document.createElement('div');
	title_footer.appendChild(title_footer_div_menu);
	var fullscreen_element=document.createElement('img');
	fullscreen_element.setAttribute('id','menu-fullscreen');
	fullscreen_element.setAttribute('src','img/fullscreen.png');
	title_footer_div_menu.appendChild(fullscreen_element);
